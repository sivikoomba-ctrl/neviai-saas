  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleLogin} className="bg-[#1e293b] rounded-xl border border-[#334155] p-6 space-y-5">
          <div>
        ...
        <button
          ...
          className="w-full bg-[#1e293b] border border-[#334155] hover:border-[#475569] text-white py-2.5 rounded-lg text-sm font-medium transition-colors flex items-center justify-center gap-3"
        >
